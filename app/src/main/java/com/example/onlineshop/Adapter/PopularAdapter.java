...
import com.example.onlineshop.databinding.ViewhplderPopularBinding;
...
public class PopularAdapter extends RecyclerView.Adapter<PopularAdapter.Viewholder> {
    ...
    public PopularAdapter.Viewholder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        ViewhplderPopularBinding binding = ViewhplderPopularBinding.inflate(LayoutInflater.from(context), parent, false);
    ...
    public class Viewholder extends RecyclerView.ViewHolder {
        ViewhplderPopularBinding binding;
        public Viewholder(ViewhplderPopularBinding binding) {
