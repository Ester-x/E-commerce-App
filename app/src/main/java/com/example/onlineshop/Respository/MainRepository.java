    ...
    public LiveData<ArrayList<CategoryModel>> loadCategory(){
        ...
        ref.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                for (DataSnapshot childSapshot : snapshot.getChildren()){
                    CategoryModel item = childSapshot.getValue(CategoryModel.class);
                    if(item != null)
                        list.add(item);
                }
    ...
    public LiveData<ArrayList<BannerModel>> loadBanner(){
        ...
        ref.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                for (DataSnapshot childSapshot : snapshot.getChildren()){
                    BannerModel item = childSapshot.getValue(BannerModel.class);
                    if(item != null)
                        list.add(item);
                }
                listData.setValue(list);
    ...
    public LiveData<ArrayList<ItemsModel>> loadPopular(){
        ...
        ref.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                for (DataSnapshot childSapshot : snapshot.getChildren()){
                    ItemsModel item = childSapshot.getValue(ItemsModel.class);
                    if(item != null)
                        list.add(item);
                }
                listData.setValue(list);
